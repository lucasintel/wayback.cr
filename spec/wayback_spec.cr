...
describe Wayback do
  describe ".snapshots" do
    it "returns the snapshots for url" do
      ...
      result = Wayback.snapshots("https://ria.ru", from: Time.utc(2022, 1, 1), to: Time.utc(2022, 4, 1), earliest: 5)
  ...
  describe ".latest_snapshot" do
    it "returns the snapshots for url" do
      ...
      result = Wayback.latest_snapshot("https://ria.ru")
  ...
  describe ".first_snapshot" do
    it "returns the snapshots for url" do
      ...
      result = Wayback.first_snapshot("https://ria.ru")
      result.should_not be_nil
      if result
        result.id.should eq("ru,ria)/")
      end
